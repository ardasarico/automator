...
export const catalog: readonly CatalogEntry[] = [
  ...
  },
  {
    ...
    category: "integration",
    group: "usdc",
    label: "Collect USDC payment",
    description: "Ask the visitor to pay USDC from their own wallet, and verify it.",
    icon: remix(RiBankCardLine),
    inputs: [port("amount", "Amount")],
    outputs: [port("paid", "Paid"), port("declined", "Declined")],
  },
  {
    type: "usdc.payout",
    category: "integration",
