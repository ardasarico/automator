...
/*
 * Vendored from React Bits (`WebThreads-TS-CSS`, https://reactbits.dev), which ships through the
 * shadcn registry this repository does not use. Kept close to upstream so it can be re-pulled;
 * the local edits are the "use client" directive Next needs, the stylesheet's filename, and two
 * conditional expressions rewritten as statements because the linter refuses unused expressions.
 */
