  ...
  const defaultProps = {
    children: (
      <>
        ...
        <RiExpandUpDownLine aria-hidden="true" className={selectTriggerIconClassName} />
      </>
    ),
  ...
  return (
    <SelectPrimitive.Portal {...portalProps}>
      <SelectPrimitive.Positioner
        ...
        anchor={anchor}
        className="z-(--z-popover) select-none"
      ...
      >
        ...
        >
          ...
          >
            <RiArrowUpSLine aria-hidden="true" className="relative size-4.5 sm:size-4" />
          </SelectPrimitive.ScrollUpArrow>
          ...
          >
            <RiArrowDownSLine aria-hidden="true" className="relative size-4.5 sm:size-4" />
          </SelectPrimitive.ScrollDownArrow>
        </SelectPrimitive.Popup>
      </SelectPrimitive.Positioner>
...
export function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      className={cn(
        "grid min-h-9 in-data-[side=none]:min-w-[calc(var(--anchor-width)+1.25rem)] cursor-default grid-cols-[0.875rem_minmax(0,1fr)] items-center gap-1.5 rounded-sm py-1.5 ps-[11px] pe-3 text-base outline-none data-disabled:pointer-events-none data-highlighted:bg-accent data-highlighted:text-accent-foreground data-disabled:opacity-64 sm:min-h-8 sm:ps-[9px] sm:text-sm [&_svg:not([class*='size-'])]:size-4.5 sm:[&_svg:not([class*='size-'])]:size-4 [&_svg]:pointer-events-none [&_svg]:shrink-0",
        className,
      )}
